...
if &background ==# 'dark'
    ...
    hi CursorLine ctermfg=NONE ctermbg=237 guifg=NONE guibg=#35444f guisp=NONE cterm=NONE gui=NONE
    ...
    hi StatusLineNC ctermfg=145 ctermbg=237 guifg=#abb0c0 guibg=#33414c guisp=NONE cterm=NONE gui=NONE
    ...
    hi VertSplit ctermfg=237 ctermbg=NONE guifg=#2b3740 guibg=NONE guisp=NONE cterm=NONE gui=NONE
...
hi CursorLine ctermfg=NONE ctermbg=254 guifg=NONE guibg=#e5dfcf guisp=NONE cterm=NONE gui=NONE
...
hi StatusLineNC ctermfg=240 ctermbg=254 guifg=#485a62 guibg=#eae3d7 guisp=NONE cterm=NONE gui=NONE
...
hi VertSplit ctermfg=254 ctermbg=NONE guifg=#efe4d2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
